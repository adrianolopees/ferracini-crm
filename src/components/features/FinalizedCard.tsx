...
function HistoryCard({ customer }: HistoryCardProps) {
  return (
    <div className="border-l-4 border-l-emerald-500 bg-emerald-50/50 rounded-lg p-4 hover:shadow-md transition-shadow duration-200">
        ...
        <div className="flex items-center gap-2 flex-wrap">
          ...
          {customer.completedAt && (
            <div className="flex flex-wrap items-center gap-2 text-sm">
              <span className="text-gray-500 text-xs px-2 py-0.5 rounded-full font-medium bg-gray-100  ">
      ...
      <div className="border-t mt-3 pt-2 border-emerald-200 flex items-center justify-between gap-2">
        {/* Badge de Origem */}
        {customer.sourceStore === 'Jundiaí' ? (
          // Reposição Local
          <div className="inline-flex items-center gap-1.5 text-xs bg-emerald-100 px-2 py-0.5 rounded-full">
          ...
          <div className="inline-flex items-center gap-1.5 text-xs bg-blue-100 px-2 py-0.5 rounded-full">
