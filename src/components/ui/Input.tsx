...
function Input({ className = '', label, error, required, ...props }: InputProps, ref: ForwardedRef<HTMLInputElement>) {
  return (
    <div className="mb-4">
      ...
      <input
        ref={ref}
        className={`w-full px-4 py-2.5 border rounded-lg transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-blue-500 focus:border-transparent disabled:bg-gray-100 disabled:cursor-not-allowed ${
