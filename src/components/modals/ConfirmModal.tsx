...
function ConfirmModal({ isOpen, customerName, onClose, onConfirm }: ConfirmModalProps) {
  return (
    <DialogModal isOpen={isOpen} onClose={onClose} title="Confirmar Exclusão">
      <div className="space-y-4">
        <p className="text-gray-700">
          Tem certeza que deseja <span className="font-semibold text-red-600">excluir permanentemente</span>{' '}
        ...
        <div className="bg-red-50 border border-red-200 rounded-lg p-3">
          <div className="flex gap-2">
            ...
            <div>
              <p className="text-sm font-semibold text-red-800">Atenção: Esta ação é irreversível!</p>
              <p className="text-sm text-red-700 mt-1">
                Todos os dados deste cliente serão excluídos permanentemente e não poderão ser recuperados.
              </p>
            </div>
          </div>
        </div>
